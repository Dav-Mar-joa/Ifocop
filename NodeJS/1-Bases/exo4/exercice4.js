...
dns.lookup('www.fnac.com', (err, address, family) => {
    if (err) {
        console.error('Erreur lors de la recherche de l\'adresse IP:', err);
        return;
    }
    console.log('Adresse IPv4:', address);
    console.log('Famille de l\'adresse IP:', family);
});
...
const unObjet = require('mon modul.js');

const nomDeDomaine = process.argv[2]
