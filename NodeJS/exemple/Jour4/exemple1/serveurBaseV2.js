...
server.on('request', (request, response) => {
  ...
  // Evènement déclenché pour chaque partie de contenu
  // de requ
  request.on('data', (contenuDeLaRequete) => {

  });

  // Evènement déclenché une fois que la totalité
  // du contenu de la requête a été téléchargé
  request.on('end', () => {
